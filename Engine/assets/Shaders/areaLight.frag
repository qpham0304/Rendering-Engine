...
void main()
{
    ...
    translatedPoints[0] = areaLight.points[0] + lightPosition;
    translatedPoints[1] = areaLight.points[1] + lightPosition;
    translatedPoints[2] = areaLight.points[2] + lightPosition;
    translatedPoints[3] = areaLight.points[3] + lightPosition;
