...
public:
	...
	void writeUniform(std::vector<VkWriteDescriptorSet>* writes, VkDescriptorSet& dstSet, const VkDescriptorBufferInfo& bufferInfo);
	void writeImage(std::vector<VkWriteDescriptorSet>* writes, VkDescriptorSet& dstSet, const VkDescriptorImageInfo& imageInfo);
