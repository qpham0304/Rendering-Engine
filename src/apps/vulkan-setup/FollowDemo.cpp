...
void Demo::createGraphicsPipeline() {
	auto vertShaderCode = readFile("src/apps/vulkan-setup/shaders/default.vert.spv");
	auto fragShaderCode = readFile("src/apps/vulkan-setup/shaders/default.frag.spv");
