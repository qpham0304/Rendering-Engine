...
DeferredRenderer::DeferredRenderer(const int width, const int height)
{
    this->width = width;
    this->height = height;
	geometryShader.reset(new Shader("Shaders/deferredShading/gBuffer.vert", "Shaders/deferredShading/gBuffer.frag"));
    colorShader.reset(new Shader("Shaders/deferredShading/deferredShading.vert", "Shaders/deferredShading/deferredShading.frag"));
